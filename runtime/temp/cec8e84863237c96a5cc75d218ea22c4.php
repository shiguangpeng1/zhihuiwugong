<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"F:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\power\viewjurisdiction.html";i:1558930359;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
    ...
    <div style="padding: 15px;">
      ...
      <form class="layui-form" action="##">
        ...
        <div class="layui-form-item secondary">
          ...
          <div class="layui-input-block">
            <input type="checkbox" name="role" checked="<?php echo !empty($val['power_id'])?true:false; ?>" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF">
          </div>
        </div>
