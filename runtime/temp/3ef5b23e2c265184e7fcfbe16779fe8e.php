<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"F:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\power\giveJurisdiction.html";i:1558663295;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
    ...
    <div style="padding: 15px;">
      ...
      <form class="layui-form" action="##">
        ...
        <div class="layui-form-item">
          ...
          <?php foreach($data as $vv): if(in_array($vv['power_id'],$data)): ?>
          <div class="layui-input-block">
            <input type="checkbox" id="psss" data-id="<?php echo $val['power_id']; ?>" checked="<?php echo !empty($val['power_id'])?true:false; ?>" name="admin.<?php echo $val['power_id']; ?>" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF">
          </div>
        ...
        <div class="layui-form-item secondary">
          ...
          <div class="layui-input-block">
            <input type="checkbox" name="role.<?php echo $v['power_id']; ?>" checked="<?php echo !empty($val['power_id'])?true:false; ?>" lay-skin="switch" lay-filter="switchTest" lay-text="OFF|ON">
          </div>
        </div>
