<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"F:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\admin\setManagement.html";i:1558924706;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  <title>上海智慧务工-项目点管理</title>
...
<script>
  layui.use(['table', 'element'], function () {
    ...
    table.render({
      elem: '#mytable',
      url: "<?php echo url('admin/setManagement'); ?>",
      method:"post",
      title: '用户数据表',
      ...
      cols: [[
        ...
        {field: 'pro_id', title: 'ID', width: 80, fixed: 'left', sort: true,},
        {field: 'por_name', title: '项目点', width: 120,edit:true },
      ...
      delCheckData: function () {
        ...
        if (data.length > 0) {
          ...
          layer.confirm('您确认要删除所选条目吗？', function (index) {
            $.ajax({
              url:"<?php echo url('admin/dd'); ?>?pro_id="+ids,
              type:'post',
              data:ids,
