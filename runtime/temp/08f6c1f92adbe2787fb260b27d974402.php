<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"F:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\power\person.html";i:1558775907;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-side layui-bg-black left-side">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree">
        <li class="layui-nav-item"><a href="../console.html">控制台</a></li>
  ...
  layui.use(['table', 'element'], function () {
    ...
    table.render({
      ...
      cols: [[
        ...
        {field: 'site', title: '部门职称', width: 120, },
        //{field: 'status', title: '状态', width: 120},
        {field: 'mobile', title: '手机号', width: 120},
       // {field: 'site', title: '地区', width: 120},
        //{field: 'date', title: '在职时长', width: 120},
        {title: '操作', toolbar: '#barDemo', width: 127}
      ]],
      id: 'testReload',
    ...
    table.on('tool(test)', function (obj) {
      ...
      //console.log(obj)
      if (obj.event === 'del') {
        layer.confirm('您确定要删除ID为'+data.id+"的员工"+data.name+"吗？", function (index) {
          obj.del();
          layer.close(index);
        });
      }
