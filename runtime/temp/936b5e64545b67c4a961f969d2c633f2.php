<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"F:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\finance\searchSalary.html";i:1558927022;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
      ...
      <div class="demoTable">
        ...
        日期：
        <div class="layui-inline">
          <input type="text" class="layui-input" id="date-picker" placeholder=" - ">
        </div>
...
<script>
  layui.use(['table', 'element', 'laydate'], function () {
    ...
    table.render({
      elem: '#mytable',
      url: "<?php echo url('finance/searchSalary'); ?>",
      toolbar: '#toolbarDemo',
      title: '用户数据表',
      method: 'post',
